...
Like Kalman Filters, particle filter is great way to track the state of dynamic system for which we have the lot of noisy sensor and control data. Particle filtering uses a genetic mutation-selection sampling approach, with a set of particles (also called samples) to represent the posterior distribution of some stochastic process given noisy and/or partial observations.
